...
public struct Constraint {
    ...
    public func set<Value>(_ keyPath: ReferenceWritableKeyPath<NSLayoutConstraint, Value>, value: Value) -> Constraint {
        return Constraint { view, parent in
...
extension Constraint {
    ...
    {
        return constraint(kind, from: to, to: to, offset: offset, priority: priority)
    }
    ...
    public static func constraint<L>(
        _ kind: Kind,
        _ keyPath: KeyPath<UIView, L>,
        length: CGFloat,
        priority: UILayoutPriority = .required) -> Constraint
    ...
    public static func equal<L, Axis>(
        ...
        where L: NSLayoutAnchor<Axis>
    {
        return equal(to, to, offset: offset, priority: priority)
    }
    ...
    public static func const(_ constraint: NSLayoutConstraint) -> Constraint {
        return Constraint { _, _ in constraint }
    }
    ...
    public static func ratioWidth(_ multiplier: CGFloat, equalTo: NSLayoutDimension, priority: UILayoutPriority = .required) -> Constraint {
        return Constraint { view, _ in
            let constraint = view.widthAnchor.constraint(
                equalTo: equalTo,
    ...
    public static func ratioHeight(_ multiplier: CGFloat, equalTo: NSLayoutDimension, priority: UILayoutPriority = .required) -> Constraint {
        return Constraint { view, _ in
...
extension Array where Element == Constraint {
    ...
    public static func insideCenter(margin: UIEdgeInsets = .zero) -> [Constraint] {
        return .center + .inside(margin: margin)
    }
    ...
    public static func fillWidth(margin: CGFloat) -> [Constraint] {
        return fillWidth(marginLeft: margin, marginRight: margin)
    }
    ...
    public static func fillHeight(margin: CGFloat) -> [Constraint] {
        return fillHeight(marginTop: margin, marginBottom: margin)
    }
